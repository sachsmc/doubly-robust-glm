...
infunc_confint <- function(ofit, wfit) {
  ...
  gdot0 <- family(ofit)$mu.eta(predict(ofit, newdata = data0, type = "link"))
  gdot1 <- family(ofit)$mu.eta(predict(ofit, newdata = data1, type = "link"))
