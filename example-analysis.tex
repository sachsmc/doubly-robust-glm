...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{infunc\_confint }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(ofit, wfit, est, exposurename, outcomename) \{}
  
\NormalTok{  ofit }\OtherTok{\textless{}{-}} \FunctionTok{glm}\NormalTok{(ofit}\SpecialCharTok{$}\NormalTok{formula, }\AttributeTok{family =}\NormalTok{ ofit}\SpecialCharTok{$}\NormalTok{family, }
                 \AttributeTok{data =}\NormalTok{ ofit}\SpecialCharTok{$}\NormalTok{data)}
...
\NormalTok{  est1 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(ofit, }\AttributeTok{newdata =}\NormalTok{ data1, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{  est0 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(ofit, }\AttributeTok{newdata =}\NormalTok{ data0, }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
  
  
\NormalTok{  eifterms1 }\OtherTok{\textless{}{-}}\NormalTok{ data[[exposurename]] }\SpecialCharTok{/}\NormalTok{ phat }\SpecialCharTok{*} 
\NormalTok{    (data[[outcomename]] }\SpecialCharTok{{-}}\NormalTok{ est1) }\SpecialCharTok{+}\NormalTok{ (est1 }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(est1))}
  
\NormalTok{  eifterms0 }\OtherTok{\textless{}{-}}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ data[[exposurename]]) }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ phat) }\SpecialCharTok{*} 
\NormalTok{    (data[[outcomename]] }\SpecialCharTok{{-}}\NormalTok{ est0) }\SpecialCharTok{+}\NormalTok{ (est0 }\SpecialCharTok{{-}} \FunctionTok{mean}\NormalTok{(est0))}
...
\NormalTok{  ifout }\OtherTok{\textless{}{-}} \FunctionTok{t}\NormalTok{(}\FunctionTok{vcov}\NormalTok{(ofit) }\SpecialCharTok{\%*\%} \FunctionTok{t}\NormalTok{(sandwich}\SpecialCharTok{::}\FunctionTok{estfun}\NormalTok{(ofit)))}
  
\NormalTok{  XXw }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(wfit)}
\NormalTok{  XXo }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(ofit)}
\NormalTok{  hdot }\OtherTok{\textless{}{-}}\NormalTok{ XXw }\SpecialCharTok{*} \FunctionTok{family}\NormalTok{(wfit)}\SpecialCharTok{$}\FunctionTok{mu.eta}\NormalTok{(}\FunctionTok{predict}\NormalTok{(wfit, }\AttributeTok{type =} \StringTok{"link"}\NormalTok{))}
\NormalTok{  gdot0 }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(}\FunctionTok{terms}\NormalTok{(ofit), }\AttributeTok{data =}\NormalTok{ data0) }\SpecialCharTok{*} 
    \FunctionTok{family}\NormalTok{(ofit)}\SpecialCharTok{$}\FunctionTok{mu.eta}\NormalTok{(}\FunctionTok{predict}\NormalTok{(ofit, }\AttributeTok{newdata =}\NormalTok{ data0, }\AttributeTok{type =} \StringTok{"link"}\NormalTok{))}
\NormalTok{  gdot1 }\OtherTok{\textless{}{-}} \FunctionTok{model.matrix}\NormalTok{(}\FunctionTok{terms}\NormalTok{(ofit), }\AttributeTok{data =}\NormalTok{ data1) }\SpecialCharTok{*} 
    \FunctionTok{family}\NormalTok{(ofit)}\SpecialCharTok{$}\FunctionTok{mu.eta}\NormalTok{(}\FunctionTok{predict}\NormalTok{(ofit, }\AttributeTok{newdata =}\NormalTok{ data1, }\AttributeTok{type =} \StringTok{"link"}\NormalTok{))}
  
\NormalTok{  fullif1 }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(eifterms1, }
              \SpecialCharTok{{-}}\FunctionTok{diag}\NormalTok{((data[[exposurename]] }\SpecialCharTok{*}\NormalTok{ hdot }\SpecialCharTok{/}\NormalTok{ phat}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*} 
\NormalTok{                            (data[[outcomename]] }\SpecialCharTok{{-}}\NormalTok{ est1)) }\SpecialCharTok{\%*\%} \FunctionTok{t}\NormalTok{(ifweight)),}
              \FunctionTok{diag}\NormalTok{((gdot1 }\SpecialCharTok{/}\NormalTok{ phat }\SpecialCharTok{*}\NormalTok{ (phat }\SpecialCharTok{{-}}\NormalTok{ data[[exposurename]])) }\SpecialCharTok{\%*\%} \FunctionTok{t}\NormalTok{(ifout)))}
  
\NormalTok{  fullif0 }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(eifterms0, }
              \FunctionTok{diag}\NormalTok{(((}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ data[[exposurename]]) }\SpecialCharTok{*}\NormalTok{ hdot }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ phat)}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{*} 
\NormalTok{                      (data[[outcomename]] }\SpecialCharTok{{-}}\NormalTok{ est0)) }\SpecialCharTok{\%*\%} \FunctionTok{t}\NormalTok{(ifweight)),}
              \FunctionTok{diag}\NormalTok{((gdot0 }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ phat) }\SpecialCharTok{*}\NormalTok{ (data[[exposurename]] }\SpecialCharTok{{-}}\NormalTok{ phat)) }\SpecialCharTok{\%*\%} \FunctionTok{t}\NormalTok{(ifout)))}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{infunc\_confint}\NormalTok{(outfit, pwfit, ATEmean, }\StringTok{"smoker"}\NormalTok{, }\StringTok{"lbw"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
     lower      upper 
0.04285596 0.22700794 
\end{verbatim}
